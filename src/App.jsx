...
import "./App.css";
import manuhFormatura from "./assets/manuh.formatura.jpg"; // imagem que você vai trocar depois
    ...
    <div className="container">
      ...
      <div className="text-section">
        <p>
          ...
          objetivos e aproveitar cada momento dessa nova fase da vida! Que o
          futuro traga muitas conquistas e sorrisos! 💫
        </p>
      </div>
